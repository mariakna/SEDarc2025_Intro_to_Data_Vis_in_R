...
We've looked at how to create box plots and we've also looked at how to represent variables with colour. Let's combine these strands of knowledge to create a box plot for `mpg` by number of cylinders:
